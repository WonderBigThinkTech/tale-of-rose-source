            ...
            <div class="customer-form__wrapper">
                <div class="customer-register-form__wrapper wrapper" id="CustomerLoginForm">
                    ...
                    <div class="customer-form__title-wrapper">
                        <h1 class="customer-form__title">Create Product</h1>
                    </div>
                            ...
                            function showFileInputs() {
                                ...
                                <div class="customer-form__fieldset-last-name">
                                    ...
                                    <select name="flower_type" id="selectBox"
                                        ...
                                        <option value="Preserved Flower">
                                            Preserved Flower
                                        </option>
                                        <option value="Fresh Flower">
                                            Fresh Flower
                                        </option>
                                    </select>
                                </div>
 
                                <div class="customer-form__fieldset-label">
                                    <label class="customer-form__fieldset-label" for="event">Event</label>
                                    <select multiple name="event[]" id="type"
                                ...
                                <!--div class="customer-form__fieldset-last-name">
                                    <label class="customer-form__fieldset-label" for="type">Type</label>
                                ...
                                <div class="customer-form__fieldset-last-name">
                                    <label class="customer-form__fieldset-label" for="material">Material</label>
                                ...
                                <div class="customer-form__fieldset-last-name">
                                    <label class="customer-form__fieldset-label" for="size">Size</label>
                                ...
                                <div class="customer-form__fieldset-last-name">
                                    <label class="customer-form__fieldset-label" for="shape">Shape</label>
                                ...
                                <!--div class="customer-form__fieldset-last-name">
                                    <label class="customer-form__fieldset-label" for="productimage">Product Image</label>
                                    <input type="file" class="customer-form__input" name="productimage" id="image" required>
                                    <div id="display-multiple-image" style="display: flex; justify-content: center;"></div>
                                </div-->

                                <button type="submit" value="Create" class="customer-form__button">Create</button>
                            </div>
                        </div>
                    </form>
                </div>
