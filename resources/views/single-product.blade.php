<x-layout>
 ...
 ">
                        ...
                        <div class="breadcrumbs" aria-label="breadcrumbs">
                            ...
                            <span class="breadcrumbs__item">{{ $product->name }}</span>
                            ...
                            <div class="new-product-price">
                                ...
                                <span class="new-current-price" id="product-price" data-product-price="6898">
                                    ...
                                    <span class="new-current-price-wrapper">
                                        ...
                                        <span class="product-symbol-price price">{{env('PAYMENT_CURRENCY_SYMBOL')}}</span>
  ...
  @if ($eachcolor)
                                        ...
                                        @foreach ($product->images()->get() as $image)
                                            ...
                                            <div class="product-slider-image-wrapper magnify-zoom variant__image"
                                                ...
                                                data-position="{{ $image->id }}">

                                                <img width="600" height="600"

                                                    src="/storage/products/{{ $image->name }}"

                                                    alt="{{ $image->name }}" class="slick-img"

                                                    data-magnify-src="/storage/products/{{ $image->name }}"
                                    ...
                                    <div style="opacity: 0; visibility: hidden;" class="product-slider product-slider-thumbnails invisible ">
                                        ...
                                        @else
                                         @foreach ($product->images()->get() as $image)
                                            ...
                                            <div class="product-slider__image-wrapper"
                                                ...
                                                data-forloop-index="{{ $image->id }}"><img width="140"

                                                    height="158" src="/storage/products/{{ $image->name }}"
                                            ...
                                            <div class="tabs-accordion-item">
                                                ...
                                                <div class="tabs-accordion-content " style="display: none;">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>Place them in a dry place without intense light to maintain
