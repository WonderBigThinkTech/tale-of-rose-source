            ...
            <div class="customer-form__wrapper">
                <div class="customer-register-form__wrapper wrapper" id="CustomerLoginForm">
                    ...
                    <div class="customer-form__title-wrapper">
                        <h1 class="customer-form__title">Edit Event {{ $event->name }} </h1>
                    </div>
                    <form enctype="multipart/form-data" method="post"
                        action="/account/admin/events/{{ $event->id }}" id="RegisterForm" accept-charset="UTF-8"
                        ...
                        <div class="customer-form__content">
                            <div class="customer-form__fieldset">
                                <div class="customer-form__fieldset-first-name">
                                    <label class="customer-form__fieldset-label" for="name">Event
                                        Name</label>
                                ...
                                <div class="customer-form__fieldset-last-name">
                                    <label class="address__edit-form-fieldset-label" for="event_group">Event
                                        Group</label>
                                    <select name="event_group" id="type"
                                        class="customer-form__input select-country" data-default="" required>

                                        <option value="Everyday Occasions"
                                            {{ $event->event_group == 'Everyday Occasions' ? 'selected' : '' }}>
                                            Everyday Occasions
                                        </option>

                                        <option value="Upcoming Occasions"
                                            {{ $event->event_group == 'Upcoming Occasions' ? 'selected' : '' }}>
                                            Upcoming Occasions
                                        </option>
                                ...
                                <div class="customer-form__fieldset-last-name">
                                    <label class="customer-form__fieldset-label" for="image">Event Image</label>
                                    <input type="file" class="customer-form__input" name="image"
                                        id="upload-button">
                                    <div style="display: flex; justify-content: center;">

                                        <img id="edit-image" style="margin: 5px 5px;"
                                            src="/storage/events/{{ $event->image }}" alt="" width="200">
