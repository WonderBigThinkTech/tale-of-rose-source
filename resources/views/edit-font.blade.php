            ...
            <div class="customer-form__wrapper">
                <div class="customer-register-form__wrapper wrapper" id="CustomerLoginForm">
                    ...
                    <div class="customer-form__title-wrapper">
                        <h1 class="customer-form__title">Edit Font [ {{ $font->name }} ]</h1>
                    </div>
                    <form enctype="multipart/form-data" method="post"
                        action="/account/admin/fonts/{{ $font->id }}/edit" id="RegisterForm" accept-charset="UTF-8"
                        ...
                        <div class="customer-form__content">
                            <div class="customer-form__fieldset">
                                <div class="customer-form__fieldset-first-name">
                                    <label class="customer-form__fieldset-label" for="name">Font
                                        Name</label>
                                    <input type="text" class="customer-form__input" value="{{ $font->name }}"
                                        name="name">
                                </div>

                                <div class="customer-form__fieldset-last-name">
                                    <label class="customer-form__fieldset-label" for="font">Font File</label>
                                    <input type="file" class="customer-form__input" name="font">
