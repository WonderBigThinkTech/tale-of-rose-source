            ...
            <div class="customer-form__wrapper">
                <div class="customer-register-form__wrapper wrapper" id="CustomerLoginForm">
                    ...
                    <div class="customer-form__title-wrapper">
                        <h1 class="customer-form__title">Edit Highlight</h1>
                    </div>
                    <form enctype="multipart/form-data" method="post" action="/custom/highlights/{{ $highlight->id }}"
                        ...
                        <div class="customer-form__content">
                            <div class="customer-form__fieldset">
                                <div class="customer-form__fieldset-first-name">
                                    <label class="customer-form__fieldset-label" for="name">Highlight name</label>
                                    <input type="text" class="customer-form__input" name="name" id="FirstName"
                                        value="{{ $highlight->name }}" autofocus>
                                </div>


                                <div class="customer-form__fieldset-last-name">
                                    <label class="customer-form__fieldset-label" for="content">Content</label>
                                    <textarea rows="10" class="customer-form__input" name="content" id="LastName">
                                    {{ $highlight->content }}
                                        </textarea>
                                </div>

                                <div class="customer-form__fieldset-last-name">
                                    <label class="customer-form__fieldset-label" for="image">Highlight
                                        Image</label>
                                    ...
                                    <div style="display: flex; justify-content: center;">
                                        ...
                                        <img id="edit-image" style="margin: 5px 5px;"
                                            src="/storage/highlights/{{ $highlight->image }}" alt=""
                                            width="200">
