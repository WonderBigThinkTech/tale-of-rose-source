            ...
            <div class="customer-form__wrapper">
                <div class="customer-register-form__wrapper wrapper" id="CustomerLoginForm">
                    ...
                    <div class="customer-form__title-wrapper">
                        <h1 class="customer-form__title">Edit Review</h1>
                    </div>
                    <form enctype="multipart/form-data" method="post" action="/custom/reviews/{{ $review->id }}"
                        ...
                        <div class="customer-form__content">
                            <div class="customer-form__fieldset">
                                <div class="customer-form__fieldset-first-name">
                                    <label class="customer-form__fieldset-label" for="buyer_name">Buyer name</label>
                                    <input type="text" class="customer-form__input" name="buyer_name" id="FirstName"
                                        value="{{ $review->buyer_name }}" autofocus>
                                </div>

                                <div class="customer-form__fieldset-first-name">
                                    <label class="customer-form__fieldset-label" for="buyer_title">Buyer title</label>
                                    <input type="text" class="customer-form__input" name="buyer_title" id="FirstName"
                                        value="{{ $review->buyer_title }}" autofocus>
                                </div>

                                <div class="customer-form__fieldset-last-name">
                                    <label class="customer-form__fieldset-label" for="comment">Comment</label>
                                    <textarea rows="10" class="customer-form__input" name="comment" id="LastName">
                                    {{ $review->comment }}
                                        </textarea>
                                </div>

                                <div class="customer-form__fieldset-last-name">
                                    <label class="customer-form__fieldset-label" for="image">Review Image</label>
                                    <input type="file" class="customer-form__input" name="image" id="upload-button"
                                        value="{{ $review->image }}">
                                    <div style="display: flex; justify-content: center;">

                                        <img id="edit-image" style="margin: 5px 5px;"
                                            src="/storage/reviews/{{ $review->image }}" alt="" width="200">
