            ...
            <div class="customer-form__wrapper">
                <div class="customer-register-form__wrapper wrapper" id="CustomerLoginForm">
                    ...
                    <div class="customer-form__title-wrapper">
                        <h1 class="customer-form__title">Edit Voucher</h1>
                    </div>
                    <form method="post" action="/custom/discounts/{{ $discount->id }}/edit" id="RegisterForm"
                        ...
                        <div class="customer-form__content">
                            <div class="customer-form__fieldset">
                                <div class="customer-form__fieldset-first-name">
                                    <label class="customer-form__fieldset-label" for="voucher">Voucher</label>
                                    <input type="text" class="customer-form__input" name="voucher"
                                        value="{{ $discount->voucher }}" id="FirstName" autofocus>
                                </div>


                                <div class="customer-form__fieldset-first-name">
                                    <label class="customer-form__fieldset-label" for="amount">Percentage</label>
                                    <input type="number" class="customer-form__input" name="amount"
                                        value="{{ $discount->amount }}" id="FirstName">
                                </div>
