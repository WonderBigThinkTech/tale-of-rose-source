            ...
            <div class="customer-form__wrapper">
                <div class="customer-register-form__wrapper wrapper" id="CustomerLoginForm">
                    ...
                    <div class="customer-form__title-wrapper">
                        <h1 class="customer-form__title">Create New Feature</h1>
                    </div>
                    <form enctype="multipart/form-data" method="post" action="/custom/features/create"
                        ...
                        <div class="customer-form__content">
                            <div class="customer-form__fieldset">
                                <div class="customer-form__fieldset-last-name">
                                    ...
                                    <select name="type" id="selectBox" class="customer-form__input select-country"
                                        data-default="" required>
                                        <option value="none">--Select--</option>

                                        <option value="Feature Text">
                                            Feature Text
                                        </option>
                                ...
                                <div class="customer-form__fieldset-first-name" id="textBox">
                                ...
                                <div class="customer-form__fieldset-last-name" id="imageBox">
                                    <label class="customer-form__fieldset-label" for="content">Content</label>
                            ...
                            <script>
                                ...
                                selectBox.addEventListener('change', function() {
                                    if (selectBox.value == 'Feature Text') {
                                        textBox.style.display = 'block';
                                        imageBox.style.display = 'none';
                                    } else if (selectBox.value == 'Feature Image') {
                                        textBox.style.display = 'none';
