            ...
            <div class="customer-form__wrapper">
                <div class="customer-register-form__wrapper wrapper" id="CustomerLoginForm">
                    ...
                    <div class="customer-form__title-wrapper">
                        <h1 class="customer-form__title">Create Ink</h1>
                    </div>
                    <form method="post" action="/account/admin/inks/create" id="RegisterForm" accept-charset="UTF-8"
                            ...
                            <div class="customer-form__fieldset">
                                <div class="customer-form__fieldset-first-name">
                                    ...
                                    <input type="text" class="customer-form__input" name="name" id="FirstName"
                                        placeholder="Color Name" autofocus>
                                </div>

                                <div class="customer-form__fieldset-first-name">
                                    <label class="customer-form__fieldset-label" for="color">Color
                                    </label>
                                    <input type="text" class="customer-form__input" name="color" id="FirstName"
                                        placeholder="Color ">
                                </div>
