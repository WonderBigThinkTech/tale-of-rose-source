            ...
            <div class="customer-form__wrapper">
                <div class="customer-register-form__wrapper wrapper" id="CustomerLoginForm">
                    ...
                    <div class="customer-form__title-wrapper">
                        <h1 class="customer-form__title">Edit Color [ {{ $color->name }} ]</h1>
                    </div>
                    <form enctype="multipart/form-data" method="post"
                        action="/account/admin/colors/{{ $color->id }}" id="RegisterForm" accept-charset="UTF-8"
                        ...
                        <div class="customer-form__content">
                            <div class="customer-form__fieldset">
                                <div class="customer-form__fieldset-first-name">
                                    <label class="customer-form__fieldset-label" for="name">Color
                                        Name</label>
                                    <input type="text" class="customer-form__input" value="{{ $color->name }}"
                                        name="name">
                                </div>

                                <div class="customer-form__fieldset-last-name">
                                    <label class="customer-form__fieldset-label" for="image">Color Image</label>
                                    <input type="file" class="customer-form__input" name="image"
                                        id="upload-button">
                                    <div style="display: flex; justify-content: center;">

                                        <img id="edit-image" style="margin: 5px 5px;"
                                            src="/storage/color/{{ $color->image }}" alt="" width="200">
