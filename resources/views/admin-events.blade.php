<x-layout>
    <main id="MainContent" class="main-content">
        ...
        <section id="account-layout">
            ...
            @include('admin-bar', ['title' => 'Events'])
                ...
                <div class="account__address-wrapper"><!-- start snippets/customer-address.liquid -->
                    ...
                    <table class="account__address-table" style="width: 100%; text-align: center; margin-top: 30px;">
                        <div style="display: flex;">
                            <a href="/account/admin/events/create" class="create-event-modal"
                        ...
                        <tbody>
                            @foreach ($events as $event)
                                <tr>
                                    ...
                                    <td>
                                        <img src="/storage/events/{{ $event->image }}" alt="Image"
                                            style="width: 100px; height: 100px;">
                                    </td>

                                    <td style="display: flex;">

                                        <a href="/account/admin/events/{{ $event->id }}/edit"
                                            class="edit-event-modal" aria-valuenow="{{ $event->id }}"
                                        ...
                                        <div>
                                            <button aria-valueNow="{{ $event->id }}" class="delete-event-modal"
