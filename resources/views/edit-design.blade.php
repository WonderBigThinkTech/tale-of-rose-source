<x-layout>
            ...
            <div class="customer-form__wrapper">
                ...
                <div class="customer-register-form__wrapper wrapper" id="CustomerLoginForm">
                    ...
                    <div class="customer-form__title-wrapper">
                        ...
                        <h1 class="customer-form__title">Edit [ Try Before Buy ]</h1>

                    </div>

                    <form enctype="multipart/form-data" method="post"

                        action="/account/admin/designs/{{ $product->id }}/edit" id="RegisterForm"
   ...
   @php
                                ...
                                <div class="customer-form__fieldset-last-name">
                                    ...
                                    <label class="address__edit-form-fieldset-label" for="color">Color</label>
                            ...
                            function showFileInputs() {
                                ...
                                <div class="customer-form__fieldset-last-name">
                                    ...
                                    <input type="text" class="customer-form__input" name="box_content" id="LastName"

                                        value="{{ $product->box_content }}">
