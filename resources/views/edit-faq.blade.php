            ...
            <div class="customer-form__wrapper">
                <div class="customer-register-form__wrapper wrapper" id="CustomerLoginForm">
                    ...
                    <div class="customer-form__title-wrapper">
                        <h1 class="customer-form__title">Edit FAQ</h1>
                    </div>
                    <form method="post" action="/custom/faqs/{{ $faq->id }}" id="RegisterForm"
                        ...
                        <div class="customer-form__content">
                            <div class="customer-form__fieldset">
                                <div class="customer-form__fieldset-first-name">
                                    <label class="customer-form__fieldset-label" for="name">Question</label>
                                    <input type="text" class="customer-form__input" name="question"
                                        value="{{ $faq->question }}" id="FirstName" autofocus>
                                </div>


                                <div class="customer-form__fieldset-last-name">
                                    <label class="customer-form__fieldset-label" for="answer">Answer</label>
                                    <textarea rows="10" class="customer-form__input" name="answer" id="LastName" placeholder=" Answer">
                                        {{ $faq->answer }}
                                      </textarea>
                                </div>
