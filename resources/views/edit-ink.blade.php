            ...
            <div class="customer-form__wrapper">
                <div class="customer-register-form__wrapper wrapper" id="CustomerLoginForm">
                    ...
                    <div class="customer-form__title-wrapper">
                        <h1 class="customer-form__title">Edit [ {{ $ink->name }} ]</h1>
                    </div>
                    <form method="post" action="/account/admin/inks/{{ $ink->id }}/edit" id="RegisterForm"
                        ...
                        <div class="customer-form__content">
                            <div class="customer-form__fieldset">
                                <div class="customer-form__fieldset-first-name">
                                    <label class="customer-form__fieldset-label" for="name">Ink
                                        Name</label>
                                    <input type="text" class="customer-form__input" value="{{ $ink->name }}"
                                        name="name">
                                </div>

                                <div class="customer-form__fieldset-first-name">
                                    <label class="customer-form__fieldset-label" for="color">Color
                                    </label>
                                    <input type="text" class="customer-form__input" value="{{ $ink->color }}"
                                        name="color">
                                </div>
