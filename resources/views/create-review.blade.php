            ...
            <div class="customer-form__wrapper">
                <div class="customer-register-form__wrapper wrapper" id="CustomerLoginForm">
                    ...
                    <div class="customer-form__title-wrapper">
                        <h1 class="customer-form__title">Create New Review</h1>
                    </div>
                    <form enctype="multipart/form-data" method="post" action="/custom/reviews/create" id="RegisterForm"
                        accept-charset="UTF-8" data-login-with-shop-sign-up="true" novalidate="novalidate"
                            ...
                            <div class="customer-form__fieldset">
                                ...
                                <div class="customer-form__fieldset-first-name">
                                    ...
                                    <input type="text" class="customer-form__input" name="buyer_title" id="FirstName"
                                        value="Verified Buyer" autofocus>
                                </div>

                                <div class="customer-form__fieldset-last-name">
                                    <label class="customer-form__fieldset-label" for="comment">Comment</label>
                                    <textarea rows="10" class="customer-form__input" name="comment" id="LastName" placeholder="Comment">
                                        </textarea>
                                </div>
                                ...
                                <div class="customer-form__fieldset-last-name">
                                    ...
                                    <input type="file" class="customer-form__input" name="image"
                                        id="upload-button">
